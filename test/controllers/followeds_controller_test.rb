...
class FollowedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create followed" do
    assert_difference("Followed.count") do
      post followeds_url, params: { followed: { followed_user_id: @followed.followed_user_id, user_id: @followed.user_id } }
    end
  ...
  test "should update followed" do
    patch followed_url(@followed), params: { followed: { followed_user_id: @followed.followed_user_id, user_id: @followed.user_id } }
